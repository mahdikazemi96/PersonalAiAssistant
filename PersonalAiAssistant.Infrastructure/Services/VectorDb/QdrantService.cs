using PersonalAiAssistant.Infrastructure.Models.Qdrant;
using System.Net;
using System.Net.Http.Json;
using System.Text.Json;

namespace PersonalAiAssistant.Infrastructure.Services.VectorDb
{
    public class QdrantService
    {
        ...
        public async Task<List<Contracts.Models.SearchResult>> SearchAsync(
            float[] vector,
            int limit = 5)
        {
            ...
            var documents = new List<Contracts.Models.SearchResult>();
            ...
            foreach (var point in result.Result)
            {
                ...
                documents.Add(new Contracts.Models.SearchResult
                {
                    Text = text,
